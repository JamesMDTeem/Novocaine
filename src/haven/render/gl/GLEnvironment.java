...
public abstract class GLEnvironment implements Environment {
    ...
    /** Copy of the per-pool GPU byte counts (INDICES, VERTICES, TEXTURES, VAOS, FBOS, SHADERS, PROGRAMS). */
    public long[] memBytes() {return(stats_mem.clone());}

    /** Copy of the per-pool GPU object counts (INDICES, VERTICES, TEXTURES, VAOS, FBOS, SHADERS, PROGRAMS). */
