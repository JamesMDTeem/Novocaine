...
public class MapFile {
	...
	/* The zoom cells known to be EMPTY (brodgar-io-client 74902ee1a), held strongly. zcache holds its values weakly so a loaded
	...
	private void include(long id, Coord sc) {
		...
		for(Map.Entry<ZoomCoord, ByZCoord> ent : zcache.entrySet()) {
			...
			empties.remove(zg);   // a grid is under it now; the reload decides again
		    }
		}
	    }
	    ByCoord bc;
