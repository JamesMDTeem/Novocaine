    ...
    public void run() {
        try {
            ...
            for (WItem wItem : inventory.getAllItems()) {
                // ND: spr() builds the sprite on demand -- the bare field is still null until the
                //  item has ticked once, so reading it directly skipped items in a just-opened
                //  container and stacked only part of it.
