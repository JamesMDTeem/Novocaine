 ...
 * (Board/Block) and mineable "bumlings" (a single ore/stone name). Every product LpSpec.object
...
public class ProductListHarvestSpec implements HarvestSpec {
    ...
    private final LpConfig.Key masterToggle;
    private final boolean horizontal;

    public ProductListHarvestSpec(Predicate<String> matcher, LpConfig.Key masterToggle, boolean horizontal) {
