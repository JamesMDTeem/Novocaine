...
//	y += UI.scale(60);
	...
	private static final Object combatMoveAdviceTooltip = RichText.render("Draws a moving $col[60,255,90]{green dashed border} around the combat move the combat model would use next, re-planned from the fight as it currently stands." +
			...
			"\n$col[185,185,185]{- It watches the next blow: if one swing against your openings as they stand could take more than 12% of your health (25% against players), it recommends the restoration that shrinks it most.}" +
			"\n$col[185,185,185]{- Both only matter in fights where defending saves real health: when the safest plan saves 2 health or less over the fastest, it plays the fastest kill.}" +
