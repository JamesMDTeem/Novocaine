...
//	    }
	...
	public void fuzzyget(Render out, Coord c, int rad, Consumer<ClickData> cb) {
	    ...
	    /* The fuzz box can land wholly off the clickmap (mouse outside
	     * the view, or a zero-sized widget); overlap() then gives null
	     * and pget NPEs on it. Count it as a miss (KamiClient b3f25646d). */
	    if(area == null) {
		cb.accept(null);
		return;
	    }
...
//	    });
	...
	public void wdgmsg(String msg, Object... args) {
		GameUI gui = ui.gui;
		if (gui != null && gui.nbots != null && gui.nbots.isRunning("RefillWaterContainers")){
			if (msg.equals("drop")){
				gui.nbots.close("RefillWaterContainers");
		...
		boolean safe = true;
		if(gui != null && gui.nbots != null && gui.nbots.isOpen("MiningSafetyAssistant") && MiningSafetyAssistant.preventUnsafeMiningCheckBox != null && MiningSafetyAssistant.preventUnsafeMiningCheckBox.a){
