...
build("OtherScriptsAndTools.res", "NurglingImports/LpAssistant.res",
...
build("QuickSwitchFromBelt.res", "NurglingImports/CrewBots.res",
...
build("OtherScriptsAndTools/FlowerMenuAutoSelectManager.res",
      "NurglingImports/LpAssistant/LpAssistantManager.res",
...
build("Bots/FishingBot.res",
      "NurglingImports/LpAssistant/AutoLpBot.res",
...
build("Toggles/HighlightCliffs.res",
      "NurglingImports/LpAssistant/LpAssistantToggle.res",
...
build("Bots/CellarDiggingBot.res",
      "NurglingImports/CrewBots/NCellarDiggerBot.res",
...
build("Bots/CleanupBot.res",
      "NurglingImports/CrewBots/NCleanupBot.res",
...
build("Bots/OceanScoutBot.res",
      "NurglingImports/CrewBots/NWaterScoutBot.res",
